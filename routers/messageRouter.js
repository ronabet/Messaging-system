...
router.post("/", messageValidator.validateBodyArray(), 
...
router.get("/read/",(req, res, next) => messageValidator.checkOneIdValid(req.query.messageId, res, next),wrapAsync(messageController.readMessage));
